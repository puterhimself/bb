...
Source: https://linuxcontainers.org/incus/docs/main/reference/provided_metrics/
Fetched: 2026-08-07
...
for instructions on how to work with these metrics.
Instance metrics
¶
...
incus_cpu_seconds_total{cpu="<cpu>",
mode="<mode>"}
