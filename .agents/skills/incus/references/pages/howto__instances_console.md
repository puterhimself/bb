...
Source: https://linuxcontainers.org/incus/docs/main/howto/instances_console/
Fetched: 2026-08-07
...
incus
console
command to attach to instance consoles.
...
An additional advantage is that the console is available even if the
incus-agent
process is not running.
This means that you can access the VM through the console before the
incus-agent
starts up, and also if the
incus-agent
