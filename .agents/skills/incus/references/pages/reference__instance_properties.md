...
Source: https://linuxcontainers.org/incus/docs/main/reference/instance_properties/
Fetched: 2026-08-07

Instance properties
¶
Instance properties are set when the instance is created.
They cannot be part of a
profile
.
...
Instance name requirements
¶
The instance name can be changed only by renaming the instance with the
incus
rename
command.
