...
Source: https://linuxcontainers.org/incus/docs/main/environment/
Fetched: 2026-08-07
...
false
, forces AppArmor off
INCUS_SECURITY_SELINUX
If set to
true
, turns on SELinux integration
INCUS_SKIP_INSTANCE_TYPES
If set to
true
, skip downloading instance type definitions
INCUS_UI
