...
Source: https://linuxcontainers.org/incus/docs/main/howto/migrate_from_lxc/
Fetched: 2026-08-07
...
incus-migrate
tool within a LXC container to migrate it to Incus (see
...
(
Go
) installed and get the tool with the following command:
```
...
linux64
architecture isn’t supported, either update the tool to the latest version or change the architecture in the LXC container configuration from
linux64
to either
amd64
or
