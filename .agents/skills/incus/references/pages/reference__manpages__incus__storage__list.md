...
Source: https://linuxcontainers.org/incus/docs/main/reference/manpages/incus/storage/list/
Fetched: 2026-08-07
...
s - state
```
incus storage list [<remote>:] [<filter>...] [flags]

```
Options
¶
```
  -c, --columns   Columns (default "nDdus")
