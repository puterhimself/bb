...
Source: https://linuxcontainers.org/incus/docs/main/syscall-interception/
Fetched: 2026-08-07
...
This is needed to avoid everything showing up as
nobody
/
nogroup
inside
...
It also allows access to schedulers like
SCHED_FIFO
which are generally
...
The
sysinfo
system call is used by some distributions instead of
/proc/
