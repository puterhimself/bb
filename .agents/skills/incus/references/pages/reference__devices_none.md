...
Source: https://linuxcontainers.org/incus/docs/main/reference/devices_none/
Fetched: 2026-08-07
...
A
none
device doesn’t have any properties and doesn’t create anything inside the instance.
Its only purpose is to stop inheriting devices that come from profiles.
To do so, add a device with the same name as the one that you do not want to inherit, but with the device type
none
.
