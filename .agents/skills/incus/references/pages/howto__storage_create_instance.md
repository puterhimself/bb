...
Source: https://linuxcontainers.org/incus/docs/main/howto/storage_create_instance/
Fetched: 2026-08-07
...
To use a different storage pool when creating or launching an instance, add the
--storage
flag.
