...
Source: https://linuxcontainers.org/incus/docs/main/howto/instances_access_files/
Fetched: 2026-08-07
...
To do so, make sure that you have
sshfs
...
```
For example, to set up the listener on a random port on the local machine (for example,
127.0.0.1:45467
):
```
...
Tip
You can specify a user name by passing the
--auth-user
flag.
