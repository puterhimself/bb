...
Source: https://linuxcontainers.org/incus/docs/main/explanation/instances/
Fetched: 2026-08-07
...
System containers are implemented through the use of
liblxc
(LXC).
...
Application containers are implemented through the use of
liblxc
(LXC) with help from
umoci
and
...
To see which features are available for virtual machines, check the condition column in the
Instance options
documentation.
See
About containers and VMs
for more information about the different instance types.
