...
Source: https://linuxcontainers.org/incus/docs/main/architectures/
Fetched: 2026-08-07
...
That means that Incus considers ARMv7 hard-float to be the same as ARMv7 soft-float and refers to both as
armv7l
.
