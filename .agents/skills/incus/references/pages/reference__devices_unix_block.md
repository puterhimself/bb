...
Source: https://linuxcontainers.org/incus/docs/main/reference/devices_unix_block/
Fetched: 2026-08-07
...
Unix block devices make the specified block device appear as a device in the instance (under
/dev
).
