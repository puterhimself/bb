...
Source: https://linuxcontainers.org/incus/docs/main/howto/benchmark_performance/
Fetched: 2026-08-07
...
If the
incus-benchmark
tool isn’t provided with your installation, you can build it from source.
Make sure that you have
go
(see
Go
) installed and install the tool with the following command:
```
...
incus-benchmark
[action]
to measure the performance of your Incus setup.
...
incus-benchmark
uses is the latest Debian image (
images:debian/12
