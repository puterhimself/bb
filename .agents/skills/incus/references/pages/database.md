...
Source: https://linuxcontainers.org/incus/docs/main/database/
Fetched: 2026-08-07
...
Cowsql
, a distributed version of SQLite.
...
File location
¶
The database files are stored in the
database
...
for instructions on how to back up the contents of the Incus database.
